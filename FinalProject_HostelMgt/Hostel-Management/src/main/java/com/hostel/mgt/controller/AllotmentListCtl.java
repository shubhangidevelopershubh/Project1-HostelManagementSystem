...
/**
 * Servlet implementation class AllotmentListView
 */
@WebServlet(name="AllotmentListCtl",urlPatterns={"/ctl/allotmentList"})
public class AllotmentListCtl extends BaseCtl {
	...
	protected BaseBean populateBean(HttpServletRequest request) {
		log.debug("AllotmentListCtl populateBean method start");
		AllotmentBean bean = new AllotmentBean();

		bean.setName(DataUtility.getString(request.getParameter("name")));

		log.debug("AllotmentListCtl populateBean method end");
		return bean;
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		log.debug("AllotmentListCtl doGet Start");
		List list = null;
		...
		log.debug("AllotmentListCtl doPOst End");
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		log.debug("AllotmentListCtl doPost Start");
		...
		try {
			...
			if (OP_SEARCH.equalsIgnoreCase(op) || "Next".equalsIgnoreCase(op) || "Previous".equalsIgnoreCase(op)) {
				...
				if (ids != null && ids.length > 0) {
					AllotmentBean deletebean = new AllotmentBean();
					for (String id : ids) {
		...
		log.debug("AllotmentListCtl doGet End");
	}

	@Override
	protected String getView() {
		// TODO Auto-generated method stub
		return HMSView.ALLOTMENT_LIST_VIEW;
	}
